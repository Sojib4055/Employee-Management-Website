...
$sql = "SELECT ID, Fname, Lname,  points FROM employeeinfo, rank WHERE rank.EID = employeeInfo.ID  order by rank.points desc";
...
<html>
<head>
	<title>Coders Com-Admin</title>
	<link rel="stylesheet" type="text/css" href="styleemplog.css">
</head>
<body>
