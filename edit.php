...
$sql = "SELECT * FROM `employeeinfo` WHERE 1";
...
$result = mysqli_query($conn, "UPDATE `employeeinfo` SET `Fname`='$firstname',`Lname`='$lastname',`Email`='$email',`Bdate`='$birthday',`Gender`='$gender',`contact`='$contact',`Nid`='$nid',`address`='$address',`department`='$dept',`degree`='$degree' WHERE ID=$id");
